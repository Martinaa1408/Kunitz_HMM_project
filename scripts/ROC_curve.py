...
set1_df = pd.read_csv("/home/martina_caste/Kunitz_HMM_project/results/set_1_finale.class", sep=None, engine="python", header=None)
set2_df = pd.read_csv("/home/martina_caste/Kunitz_HMM_project/results/set_2_finale.class", sep=None, engine="python", header=None)
